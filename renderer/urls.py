...
from .views import render_timeline, render_login_email, render_password_login, render_profile, render_edit_profile
...
urlpatterns = [
    ...
    path('edit/', render_edit_profile, name='edit_profile'),]